...
[LayersCollection](http://edward17.github.io/LayersCollection/) - збірка растрових шарів, заснованих на даних OpenStreetMap, і шарів, які дозволено використовуваи для редагування OSM. До них належать:
...
Цей проект прозначений для того, щоб:
...
* Базовий шар (Baselayer) - шар, що лежить на тлі мапи; шар, на який накладуються все інше
...
Також замість базового шару можна зробити то чорним (Set black background) або сірим (Set gray background).
...
Зверніть увагу: історія усіх показанних шарів **не** зберігається.

### Категорії

Категорія - це шари під заголовком (до іншого заголовку). Усі шари в одній категорії належать до однієї теми. Наприклад, у категорії "General" зібрани шари без ухилу на щось (вони показують все одразу, грубо кажучи). У категорії "Public Transport" - як можна здогадатися з назви, знаходяться шари, що відображають маршрути громадського транспорту.
...
Завдяки цьому можна швидко переходити з одного сайту на інший. Наприклад, ви побачили помилку в одному з валідаторів http://pavlo-dudka.github.io/ , і хочете подивитись, як виглядає це місце на супутникових знімках. Порядок дій наступний:

1. Скопіювати посилання на це місце на ціому сайті
2. Вставити її, наприклад, в адресну строку браузера
3. Залишити тільки хеш, все інше прибрати
4. Скопіювити отриманий хеш
5. Набрати в адресній строці `http://edward17.github.io/LayersCollection/` і вставити у кінці отриманий хеш
6. Мапа відкриється на цьому місці. Тепер можна переключтись, наприклад, на шар супутникових знімків
...
Окрім того, кожний фільтр має певну "бирку" (в списку вище вони описані у дужках). Якщо шар подходить під якийсь фільтр, бирка цього фільтру зображується праворуч від назви шара.
...
Власний шар додається над обраним зараз базовим шаром. Якщо ваш шар має прозорой фон, але ви хочете бачити його без підкладки, то натисніть на кнопку "Set gray background" у переліку шарів.

Зверніть увагу:

1. Данні цього шару (адреса, авторські права, максимальний зум тощо) не зберігаються і навіть під час перезавантаження сторінки будуть втрачені
2. За допомогою цього інструменту **не** можна попросити автора (мене) додати цей шар до збірки. Для цього потрібно зв'язатись зі мною. Про це написано у розділі "Зв'язок"
...
Інтерфейс сайту можна змінювати. Деякі налаштування зберігаються тільки в браузері. Інші налаштування зберігаються у браузері та у посиланні. При цьому налаштування у посиланні завжди мають більший пріорітет, ніж наоаштування, збережені у браузері.
